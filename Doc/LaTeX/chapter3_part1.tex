...
\hline
RQ4 / H4 & Xác định nhóm đặc trưng đóng góp chính cho dự đoán stress & Quy trình lựa chọn đặc trưng theo domain knowledge + Random Forest importance (Mục~\ref{sec:feature_selection}) làm nền cho phân tích tầm quan trọng đặc trưng ở Chương~\ref{chap:experiments}. \\
\hline
\end{tabular}
\end{table}
