...
\]
\begin{itemize}
    \item Activity quyết định khả năng dùng điện thoại.
    \item Location điều chỉnh theo bối cảnh.
    \item Stress chỉ tăng nhẹ, không chi phối toàn bộ feature.
\end{itemize}
...
\]
\begin{itemize}
    \item Mood nền dao động theo ngày/sự kiện.
    \item Stress cao kéo mood xuống vừa phải.
\end{itemize}
...
\]
\begin{itemize}
    \item Biến tiềm ẩn về phục hồi/fatigue.
    \item Bị ảnh hưởng bởi chu kỳ, mệt mỏi tuần và sự kiện.
\end{itemize}
\end{columns}

\vspace{0.08cm}
\fbox{\parbox{0.92\textwidth}{\centering\scriptsize\textbf{Nguồn neo:} Mobile sensing, MoodScope và StudentLife hỗ trợ liên hệ giữa phone usage, mood, sleep, activity; các hệ số vẫn là heuristic chuẩn hóa, không phải công thức lâm sàng.}}
\end{frame}
